...
**描述**: -t 1, -c 2, -kv false, -mmp 0, -dyo 0, -vp 0， 扫描 p/n 网格，使用内部固定 prompt 模式 0。
...
**描述**: -t 1, -c 2, -kv false, -mmp 0, -dyo 0, -vp 1， 扫描同样的 p/n 网格，使用内部固定 prompt 模式 1。
